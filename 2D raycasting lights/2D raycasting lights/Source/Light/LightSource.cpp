...
LightSource::LightSource(Vector2f position, int stepSize)
{
	...
	////makes pointA ray for every stepSize amount. If stepsize is 1 then its 1 ray pr degree. 
	...
	//	//Makes pointA new ray with the same start positon as the light, and converts radians to pointA vector. 
