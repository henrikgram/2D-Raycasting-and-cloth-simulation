...
// Specialization using pointA functor (including free functions) with no argument
template <typename T>
...
// Specialization using pointA functor (including free functions) with one argument
...
// Specialization using pointA member function
template <typename C>
