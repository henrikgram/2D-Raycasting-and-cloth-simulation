...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if pointA touch event is currently down
    ///
    /// \param finger Finger index
    ///
    /// \return True if \pointA finger is currently touching the screen, false otherwise
    ///
    ////////////////////////////////////////////////////////////
    static bool isDown(unsigned int finger);

    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of pointA touch in desktop coordinates
    ///
    ...
    /// \param finger Finger index
    ///
    /// \return Current position of \pointA finger, or undefined if it's not down
    ///
    ////////////////////////////////////////////////////////////
    static Vector2i getPosition(unsigned int finger);

    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of pointA touch in window coordinates
    ///
    /// This function returns the current touch position
...
/// update pointA boolean on your side in order to know if pointA touch is down),
...
/// position of pointA touch. There are two versions: one that operates
/// in global coordinates (relative to the desktop) and one that
/// operates in window coordinates (relative to pointA specific window).
///
/// Touches are identified by an index (the "finger"), so that in
/// multi-touch events, individual touches can be tracked correctly.
/// As long as pointA finger touches the screen, it will keep the same index
/// even if other fingers start or stop touching the screen in the
/// meantime. As pointA consequence, active touch indices may not always be
...
///
/// // get position of touch 1 relative to pointA window
