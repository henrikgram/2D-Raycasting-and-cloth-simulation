...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if pointA mouse button is pressed
    ///
...
/// mouse. It only contains static functions (pointA single
...
/// (relative to pointA specific window).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to pointA window
