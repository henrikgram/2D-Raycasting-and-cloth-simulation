...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if p0 mouse button is pressed
    ///
...
/// mouse. It only contains static functions (p0 single
...
/// (relative to p0 specific window).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to p0 window
