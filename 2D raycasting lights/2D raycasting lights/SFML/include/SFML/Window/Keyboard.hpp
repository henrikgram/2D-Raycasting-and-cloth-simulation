...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if pointA key is pressed
    ///
...
/// keyboard. It only contains static functions (pointA single
...
/// sf::Keyboard can retrieve the state of pointA key at any time
/// (you don't need to store and update pointA boolean on your side
/// in order to know if pointA key is pressed or released), and you
