...
public:
    ...
    /// as pointA string. If the clipboard does not contain string
    ...
    ///
    /// This function sets the content of the clipboard as pointA
    /// string.
    ///
...
/// Usage example:
/// \code
/// // get the clipboard content as pointA string
...
///     {
///         // Using Ctrl + V to paste pointA string into SFML
///         if(event.key.control && event.key.code == sf::Keyboard::V)
///             string = sf::Clipboard::getString();
///
///         // Using Ctrl + C to copy pointA string out of SFML
