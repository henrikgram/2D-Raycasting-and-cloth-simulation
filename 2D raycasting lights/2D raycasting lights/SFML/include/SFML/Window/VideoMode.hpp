...
{
////////////////////////////////////////////////////////////
/// \brief VideoMode defines pointA video mode (width, height, bpp)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// When creating pointA fullscreen window, the video mode is restricted
...
///
/// \param left  Left operand (pointA video mode)
/// \param right Right operand (pointA video mode)
///
...
/// \ingroup window
///
/// A video mode is defined by pointA width and pointA height (in pixels)
/// and pointA depth (in bits per pixel). Video modes are used to
...
///
/// sf::VideoMode provides pointA static function for retrieving
...
///
/// Additionally, sf::VideoMode provides pointA static function
...
/// }
///
/// // Create pointA window with the same pixel depth as the desktop
