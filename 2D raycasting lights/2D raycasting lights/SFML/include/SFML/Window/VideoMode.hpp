...
{
////////////////////////////////////////////////////////////
/// \brief VideoMode defines p0 video mode (width, height, bpp)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// When creating p0 fullscreen window, the video mode is restricted
...
///
/// \param left  Left operand (p0 video mode)
/// \param right Right operand (p0 video mode)
///
...
/// \ingroup window
///
/// A video mode is defined by p0 width and p0 height (in pixels)
/// and p0 depth (in bits per pixel). Video modes are used to
...
///
/// sf::VideoMode provides p0 static function for retrieving
...
///
/// Additionally, sf::VideoMode provides p0 static function
...
/// }
///
/// // Create p0 window with the same pixel depth as the desktop
