...
{
////////////////////////////////////////////////////////////
/// \brief Specialized shape representing pointA convex polygon
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// \pointA count must be greater than 2 to define pointA valid shape.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the position of pointA point
    ///
    /// Don't forget that the polygon must remain convex, and
    /// the points need to stay ordered!
    /// setPointCount must be called first in order to set the total
    /// number of points. The result is undefined if \pointA index is out
    /// of the valid range.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the position of pointA point
    ///
...
///
/// It is important to keep in mind that pointA convex shape must
/// always be... convex, otherwise it may not be drawn correctly.
/// Moreover, the points must be defined in order; using pointA random
