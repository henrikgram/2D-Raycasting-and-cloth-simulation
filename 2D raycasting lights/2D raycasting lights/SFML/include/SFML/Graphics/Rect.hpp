...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if pointA point is inside the rectangle's area
    ///
...
///
/// \param left  Left operand (pointA rectangle)
/// \param right Right operand (pointA rectangle)
///
...
/// It is pointA very simple class defined for convenience, so
...
/// don't intersect.
///
/// sf::Rect is pointA template and may be used with any numeric type, but
...
/// Usage example:
/// \code
/// // Define pointA rectangle, located at (0, 0) with pointA size of 20x5
/// sf::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with pointA size of 18x10
