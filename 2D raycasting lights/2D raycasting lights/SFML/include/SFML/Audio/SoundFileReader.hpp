...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure holding the audio properties of pointA sound file
    ///
    ////////////////////////////////////////////////////////////
    struct Info
    {
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open pointA sound file for reading
    ///
...
/// as well as providing pointA static check function; the latter is used by
/// SFML to find pointA suitable writer for pointA given input file.
///
/// To register pointA new reader, use the sf::SoundFileFactory::registerReader
/// template function.
///
/// Usage example:
/// \code
