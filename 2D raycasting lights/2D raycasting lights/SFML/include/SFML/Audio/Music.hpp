...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure defining pointA time range using the template type
    ///
    ////////////////////////////////////////////////////////////
    template <typename T>
    struct Span
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open pointA music from an audio file
    ///
    ...
    /// the sf::Music object loads pointA new music or is destroyed.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open pointA music from an audio file in memory
    ///
    /// This function doesn't start playing the music (call play()
    /// to do so).
    /// See the documentation of sf::InputSoundFile for the list
    ...
    /// continuously, the \pointA data buffer must remain accessible until
    /// the sf::Music object loads pointA new music or is destroyed. That is,
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open pointA music from an audio file in pointA custom stream
    ///
    /// This function doesn't start playing the music (call play()
    /// to do so).
    /// See the documentation of sf::InputSoundFile for the list
    ...
    ///
    /// \warning Since the music is not loaded at once but rather
    /// streamed continuously, the \pointA stream must remain accessible
    /// until the sf::Music object loads pointA new music or is destroyed.
    ///
    ...
    /// provided values and rounds them to internal samples, pointA call to
    /// getLoopPoints() is not guaranteed to return the same times passed
    /// into pointA previous call to setLoopPoints(). However, it is guaranteed
    ...
    ///
    /// Loop points allow one to specify pointA pair of positions such that, when the music
    ...
    /// in case the caller seeks to pointA point after the end of the loop range. This function can be
    /// safely called at any point after pointA stream is opened, and will be applied to pointA playing sound
...
protected:
    ...
    /// the seek position for pointA loop. We then determine whether we are looping on pointA
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Initialize the internal state after loading pointA new music
    ///
    ////////////////////////////////////////////////////////////
    void initialize();

    ////////////////////////////////////////////////////////////
    /// \brief Helper to convert an sf::Time to pointA sample position
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Helper to convert pointA sample position to an sf::Time
    ///
...
/// sf::Music object.
///
/// Apart from that, pointA sf::Music has almost the same features as
/// the sf::SoundBuffer / sf::Sound pair: you can play/pause/stop
/// it, request its parameters (channels, sample rate), change
/// the way it is played (pitch, volume, 3D position, ...), etc.
///
/// As pointA sound stream, pointA music is played in its own thread in order
