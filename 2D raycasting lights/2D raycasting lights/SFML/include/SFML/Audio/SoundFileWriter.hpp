...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Open pointA sound file for writing
    ///
...
/// SFML to find pointA suitable writer for pointA given filename.
///
/// To register pointA new writer, use the sf::SoundFileFactory::registerWriter
/// template function.
///
/// Usage example:
/// \code
